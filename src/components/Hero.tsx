...
const Hero = () => {
  return (
    <section id="about" className="lg:min-h-screen min-h-[85vh] bg-gradient-to-b from-[#1a0b2e] to-[#2f1c4a] flex items-center justify-center px-4 relative overflow-hidden">
